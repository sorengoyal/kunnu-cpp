...
ui  = Expression(("0.0","-40.0*sin(pi*x[0])*sin(pi*x[1])*exp(-1000.*(pow(x[0]-0.5,2)+pow(x[1]-0.5,2) - t))"), t=0.0)
u0 = interpolate(ui, V)
...
file = File("/home/crg/Documents/Linear_Test/4Parallel128_SCALING/Test1.pvd")
count=0
while t <= T:
 t += dt
 solver.solve()
